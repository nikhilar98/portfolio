    ...
    sections: [
      {
        ...
        items: [
          ...
          'Developed dynamic UI rendering 5+ WiFi package tiers with real-time pricing and availability, contributing to a ~20% increase in onboard WiFi adoption.',
      ...
      },
      {
        ...
        items: [
          ...
          'Ensured WCAG 2.1 AA compliance across 3 display resolutions with 95+ Lighthouse accessibility score, meeting airline regulatory certification requirements.',
